...
##### 1#       楼主       发表于 2024-1-15 14:58
 ...
 本帖最后由 慕容断月 于 2025-8-28 05:00 编辑 
...
PS：因为用的美版EXE忘了打开字幕，有需要字幕的人可以去Scripts目录下的NFSU2ExtraOptionsSettings.ini文件里找到[Menu]这项，在第四行ShowSubs = 0这里，把0改成1就可以打开字幕了。
...
####  慕容断月  
##### 56#         楼主| 发表于 2026-6-20 03:00

经过了两天的高强度vibe和对mcp服务器的不懂到测试，在前人的肩膀上终于做完了win8以上的变速1中文版绕过验证补丁（虽然完全不vibe也可以直接搞个SRLoader就能用）

基于这个搞了一个steam版转官中包有兴趣回头传一下

至于13代中文本体我打算等再vibe一下看能不能把securom v7给去掉，不能就算了，都下架好几年，发售至今都马上20年的游戏，应该没事吧<img src="https://static.stage1st.com/image/smiley/face2017/037.png" referrerpolicy="no-referrer">
...
####  慕容断月  
##### 58#         楼主| 发表于 2026-7-3 21:22

最后有个遗憾，4代的汉化补丁找不到足够纯净的，不然可以问问ai能不能修
