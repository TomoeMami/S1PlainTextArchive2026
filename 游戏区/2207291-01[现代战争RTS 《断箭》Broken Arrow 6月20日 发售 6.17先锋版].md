...
####  WGTCorp  
##### 152#       发表于 2026-4-1 23:25

这次更新平衡性改动如下：

单位自定义现在可更改其标签图标，以便更好地区分使用的版本；

“水坝”地图已重制，减少了森林覆盖面积。抬高了低地势一方的海拔，为防空导弹提供更好的视线；

新增了紧急空投功能：双击空投按钮立即启动空投。也可通过点击飞机货舱面板中的单位图标，单独空投单位；

步兵伤害如今根据小队人数计算。人数较多的小队受到的伤害略高，人数较少则略低。小队人数动态计算，实时反映战斗减员。

调整了针对飞机的“过度杀伤”机制，始终允许立即发射第二枚导弹。此前，如果第一枚导弹伤害极高（S-300），需要投放热诱弹才能触发第二枚导弹发射

略微降低了直升机移动惯性，使其反应更灵敏

火炮烟雾持续时间从 60 秒增加至 90 秒

152mm 及以上口径榴弹炮瞄准时间从 12-15 秒增加至 16-20 秒

多管火箭炮瞄准时间从 20-24 秒增加至 25-30 秒

步兵重机枪（勃朗宁/科尔德）现在采用与载具重机枪相同的模型，DPS 提升约 50%。同时，其弹药储备也已翻倍，以补偿更高的弹药消耗。

步兵中型机枪和中口径精确射手步枪伤害提升（从 1.2/1.5/1.8 提升至 1.5/1.8/2）

降低了坦克炮散布，远程射击的脱靶率降低

精确制导弹药瞄准时间现在在飞机达到高空后才开始计算；

修复：SRAW 现在可通过强制开火命令向地面射击。

好像没有针对某个具体单位的平衡性调整。我更新后还没打过PVP，看群友说法是重机枪班崛起，美团大班相比之前死得飞快，身管火炮除了专打固定靶的芍药之外似乎都废了，总体上对elb是加强。
